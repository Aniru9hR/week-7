...
t.test(release_year, metascore, var.equal = TRUE)
```

---
 0.1076894   for the mean of x and -0.1605230  for the mean of y the sample means (x and y), which are the sample estimates. In this instance, release_year  mean is 0.1076894 , whereas metascore mean is -0.1605230 
---
