...
Observation:
  the ozone has relationship with respect to temperature

Question:
  is there a relationship between ozone  with respect to temperature?
  
Hypothesize:
null hypothesis-there is no relationship between the ozone with respect to temperature
alternate hypothesis-there is a relationship between the ozone with respect to temperature
